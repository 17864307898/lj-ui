export default {
  ...
  ljCharts: {
    ...
    fileDistribute: 'Risk of license',
    packageDistribute: 'Risk of compatibility',
    sourceProjectDistribute: 'Risk of tampering',
    ...
    // 以下字段名称待定
    highRiskFile: 'High risk',
    midRiskFile: 'Medium risk',
    lowRiskFile: 'Low risk',
    noRiskFile: 'No permit',
    /************/
